        ...
        <div class="card-body">
            <form id="setNewPasswordForm" method="post">
                ...
                <div class="form-group">
                    <input type="submit" id="setNewPasswordSubmit" class="btn float-right login_btn">
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).on('click','#setNewPasswordSubmit',function () {

        var frm = $('#setNewPasswordForm');
